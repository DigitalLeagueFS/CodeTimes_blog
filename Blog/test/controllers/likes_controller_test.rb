...
class LikesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create like" do
    assert_difference('Like.count') do
      post likes_url, params: { like: { comment_id: @like.comment_id, post_id: @like.post_id, user_id: @like.user_id } }
    end
  ...
  test "should update like" do
    patch like_url(@like), params: { like: { comment_id: @like.comment_id, post_id: @like.post_id, user_id: @like.user_id } }
