...
class AttachmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create attachment" do
    assert_difference('Attachment.count') do
      post attachments_url, params: { attachment: { link: @attachment.link, post_id: @attachment.post_id, type: @attachment.type } }
    end
  ...
  test "should update attachment" do
    patch attachment_url(@attachment), params: { attachment: { link: @attachment.link, post_id: @attachment.post_id, type: @attachment.type } }
